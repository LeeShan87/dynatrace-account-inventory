...
// checks if the LogJobRecordsTopValuesRestResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogJobRecordsTopValuesRestResult{}
...
func (o *LogJobRecordsTopValuesRestResult) GetParsingFieldTopValues() []ParsingFieldTopValue {
	if o == nil || IsNil(o.ParsingFieldTopValues) {
