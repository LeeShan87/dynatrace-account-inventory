...
// checks if the Host4pg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Host4pg{}
...
func (o *Host4pg) GetContentAccess() bool {
	if o == nil || IsNil(o.ContentAccess) {
		var ret bool
		return ret
	}
