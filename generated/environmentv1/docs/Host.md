...
**AutoInjection** | Pointer to **string** | Status of auto-injection | [optional] 
...
**AzureEnvironment** | Pointer to **string** |  | [optional] 
**AzureHostNames** | Pointer to **[]string** |  | [optional] 
**AzureResourceGroupName** | Pointer to **string** |  | [optional] 
**AzureResourceId** | Pointer to **string** |  | [optional] 
**AzureSiteNames** | Pointer to **[]string** |  | [optional] 
**AzureSku** | Pointer to **string** |  | [optional] 
**AzureVmName** | Pointer to **string** |  | [optional] 
**AzureVmScaleSetName** | Pointer to **string** |  | [optional] 
**AzureVmSizeLabel** | Pointer to **string** |  | [optional] 
**AzureZone** | Pointer to **string** |  | [optional] 
