...
**IsExternalService** | Pointer to **bool** |  | [optional] 
...
**ServiceDetectionAttributes** | Pointer to **map[string]map[string]interface{}** | Attributes that contributed to the service id. | [optional] 
