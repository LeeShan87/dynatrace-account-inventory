...
------------ | ------------- | ------------- | -------------
**AdobeEmEnvType** | Pointer to **[]string** |  | [optional] 
**AdobeEmProgram** | Pointer to **[]string** |  | [optional] 
**AdobeEmService** | Pointer to **[]string** |  | [optional] 
**AdobeEmTier** | Pointer to **[]string** |  | [optional] 
**AgentValueMetadata** | Pointer to **map[string]string** |  | [optional] 
**ApacheConfigPaths** | Pointer to **[]string** |  | [optional] 
**ApacheSparkMasterIpAddresses** | Pointer to **[]string** |  | [optional] 
**AspDotNetCoreApplicationPaths** | Pointer to **[]string** |  | [optional] 
**AwsEcrImageAccountIds** | Pointer to **[]string** |  | [optional] 
**AwsEcrImageRegions** | Pointer to **[]string** |  | [optional] 
**AwsEcsCluster** | Pointer to **[]string** |  | [optional] 
**AwsEcsContainerName** | Pointer to **[]string** |  | [optional] 
**AwsEcsFamily** | Pointer to **[]string** |  | [optional] 
...
**CatalinaBaseValues** | Pointer to **[]string** |  | [optional] 
**CatalinaHomeValues** | Pointer to **[]string** |  | [optional] 
**CloudFoundryAppIds** | Pointer to **[]string** |  | [optional] 
...
**CloudfoundryMetadata** | Pointer to **map[string]string** |  | [optional] 
**ColdfusionJvmConfigFiles** | Pointer to **[]string** |  | [optional] 
**CommandLineArgs** | Pointer to **[]string** |  | [optional] 
**DeclarativeId** | Pointer to **[]string** |  | [optional] 
**DockerContainerIds** | Pointer to **[]string** |  | [optional] 
**DockerContainerImageNames** | Pointer to **[]string** |  | [optional] 
**DockerContainerImageVersions** | Pointer to **[]string** |  | [optional] 
**DockerContainerNames** | Pointer to **[]string** |  | [optional] 
**DotNetCommands** | Pointer to **[]string** |  | [optional] 
**DotnetCommandPath** | Pointer to **[]string** |  | [optional] 
**DynatraceClusterIds** | Pointer to **[]string** |  | [optional] 
**DynatraceNodeIds** | Pointer to **[]string** |  | [optional] 
**ElasticSearchClusterNames** | Pointer to **[]string** |  | [optional] 
**ElasticSearchNodeNames** | Pointer to **[]string** |  | [optional] 
**EnvVariables** | Pointer to **map[string]string** |  | [optional] 
**EquinoxConfigPath** | Pointer to **[]string** |  | [optional] 
**ExecutablePaths** | Pointer to **[]string** |  | [optional] 
**Executables** | Pointer to **[]string** |  | [optional] 
**GlassfishDomainNames** | Pointer to **[]string** |  | [optional] 
**GlassfishInstanceNames** | Pointer to **[]string** |  | [optional] 
**GoogleAppEngineInstances** | Pointer to **[]string** |  | [optional] 
**GoogleAppEngineServices** | Pointer to **[]string** |  | [optional] 
**GoogleCloudInstanceId** | Pointer to **[]string** |  | [optional] 
**GoogleCloudInstanceRegion** | Pointer to **[]string** |  | [optional] 
**GoogleCloudProjects** | Pointer to **[]string** |  | [optional] 
**GoogleCloudRunService** | Pointer to **[]string** |  | [optional] 
**GoogleComputeEngineMetadata** | Pointer to **map[string]string** |  | [optional] 
**HostGroups** | Pointer to **[]string** |  | [optional] 
**HybrisBinDirectories** | Pointer to **[]string** |  | [optional] 
**HybrisConfigDirectories** | Pointer to **[]string** |  | [optional] 
**HybrisDataDirectories** | Pointer to **[]string** |  | [optional] 
**IbmApplid** | Pointer to **[]string** |  | [optional] 
...
GetAdobeEmProgramOk returns a tuple with the AdobeEmProgram field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetGoogleCloudInstanceRegion returns the GoogleCloudInstanceRegion field if non-nil, zero value otherwise.
...
SetIbmJobName sets IbmJobName field to given value.
