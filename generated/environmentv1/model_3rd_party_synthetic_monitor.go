...
// checks if the Model3rdPartySyntheticMonitor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Model3rdPartySyntheticMonitor{}
...
func (o *Model3rdPartySyntheticMonitor) GetDrilldownLink() string {
	if o == nil || IsNil(o.DrilldownLink) {
		var ret string
		return ret
	}
...
func (o *Model3rdPartySyntheticMonitor) GetNoDataTimeout() int32 {
	if o == nil || IsNil(o.NoDataTimeout) {
		var ret int32
		return ret
	}
