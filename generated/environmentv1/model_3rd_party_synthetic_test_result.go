...
// checks if the Model3rdPartySyntheticTestResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Model3rdPartySyntheticTestResult{}
...
func (o *Model3rdPartySyntheticTestResult) GetTotalStepCount() int32 {
	if o == nil || IsNil(o.TotalStepCount) {
		var ret int32
		return ret
	}
