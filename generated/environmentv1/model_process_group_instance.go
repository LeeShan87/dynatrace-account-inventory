...
// checks if the ProcessGroupInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessGroupInstance{}
...
func (o *ProcessGroupInstance) GetAgentVersions() []AgentVersion {
	if o == nil || IsNil(o.AgentVersions) {
...
func (o *ProcessGroupInstance) GetAzureHostName() string {
	if o == nil || IsNil(o.AzureHostName) {
		var ret string
		return ret
	}
...
func (o *ProcessGroupInstance) GetAzureSiteName() string {
	if o == nil || IsNil(o.AzureSiteName) {
		var ret string
		return ret
	}
...
func (o *ProcessGroupInstance) GetMonitoringState() MonitoringState {
	if o == nil || IsNil(o.MonitoringState) {
...
func (o *ProcessGroupInstance) GetVersionedModules() []ProcessGroupInstanceModule {
	if o == nil || IsNil(o.VersionedModules) {
