...
func (o *UserSession) GetBrowserMajorVersion() string {
	if o == nil || IsNil(o.BrowserMajorVersion) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetBrowserMonitorId() string {
	if o == nil || IsNil(o.BrowserMonitorId) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetBrowserMonitorName() string {
	if o == nil || IsNil(o.BrowserMonitorName) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetClientTimeOffset() int32 {
	if o == nil || IsNil(o.ClientTimeOffset) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetCrashGroupId() string {
	if o == nil || IsNil(o.CrashGroupId) {
		var ret string
		return ret
	}
	return *o.CrashGroupId
}

// GetCrashGroupIdOk returns a tuple with the CrashGroupId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSession) GetCrashGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.CrashGroupId) {
		return nil, false
	}
	return o.CrashGroupId, true
}
...
func (o *UserSession) GetDisplayResolution() string {
	if o == nil || IsNil(o.DisplayResolution) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetHasSessionReplay() bool {
	if o == nil || IsNil(o.HasSessionReplay) {
		var ret bool
		return ret
	}
...
func (o *UserSession) GetInternalUserId() string {
	if o == nil || IsNil(o.InternalUserId) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetMatchingConversionGoalsCount() int32 {
	if o == nil || IsNil(o.MatchingConversionGoalsCount) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetNumberOfRageClicks() int32 {
	if o == nil || IsNil(o.NumberOfRageClicks) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetNumberOfRageTaps() int32 {
	if o == nil || IsNil(o.NumberOfRageTaps) {
		var ret int32
		return ret
	}
	return *o.NumberOfRageTaps
}

// GetNumberOfRageTapsOk returns a tuple with the NumberOfRageTaps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSession) GetNumberOfRageTapsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumberOfRageTaps) {
		return nil, false
	}
	return o.NumberOfRageTaps, true
}
...
func (o *UserSession) GetReasonForNoSessionReplay() string {
	if o == nil || IsNil(o.ReasonForNoSessionReplay) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetReasonForNoSessionReplayMobile() string {
	if o == nil || IsNil(o.ReasonForNoSessionReplayMobile) {
		var ret string
		return ret
	}
	return *o.ReasonForNoSessionReplayMobile
}

// GetReasonForNoSessionReplayMobileOk returns a tuple with the ReasonForNoSessionReplayMobile field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSession) GetReasonForNoSessionReplayMobileOk() (*string, bool) {
	if o == nil || IsNil(o.ReasonForNoSessionReplayMobile) {
		return nil, false
	}
	return o.ReasonForNoSessionReplayMobile, true
}
...
func (o *UserSession) SetReasonForNoSessionReplayMobile(v string) {
	o.ReasonForNoSessionReplayMobile = &v
}
...
func (o *UserSession) GetRootedOrJailbroken() bool {
	if o == nil || IsNil(o.RootedOrJailbroken) {
		var ret bool
		return ret
	}
	return *o.RootedOrJailbroken
}

// GetRootedOrJailbrokenOk returns a tuple with the RootedOrJailbroken field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSession) GetRootedOrJailbrokenOk() (*bool, bool) {
	if o == nil || IsNil(o.RootedOrJailbroken) {
		return nil, false
	}
	return o.RootedOrJailbroken, true
}
...
func (o *UserSession) GetScreenOrientation() string {
	if o == nil || IsNil(o.ScreenOrientation) {
		var ret string
		return ret
	}
...
func (o *UserSession) GetSyntheticEvents() []UserSessionSyntheticEvent {
	if o == nil || IsNil(o.SyntheticEvents) {
...
func (o *UserSession) GetTotalErrorCount() int32 {
	if o == nil || IsNil(o.TotalErrorCount) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetTotalLicenseCreditCount() int32 {
	if o == nil || IsNil(o.TotalLicenseCreditCount) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetUserActionCount() int32 {
	if o == nil || IsNil(o.UserActionCount) {
		var ret int32
		return ret
	}
...
func (o *UserSession) GetUserExperienceScore() string {
	if o == nil || IsNil(o.UserExperienceScore) {
		var ret string
		return ret
	}
...
func (o UserSession) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CrashGroupId) {
		toSerialize["crashGroupId"] = o.CrashGroupId
	}
	...
	if !IsNil(o.HasSessionReplay) {
		toSerialize["hasSessionReplay"] = o.HasSessionReplay
	}
	if !IsNil(o.InternalUserId) {
	...
	if !IsNil(o.MatchingConversionGoalsCount) {
	...
	if !IsNil(o.NumberOfRageClicks) {
		toSerialize["numberOfRageClicks"] = o.NumberOfRageClicks
	}
	if !IsNil(o.NumberOfRageTaps) {
		toSerialize["numberOfRageTaps"] = o.NumberOfRageTaps
	}
	if !IsNil(o.OsFamily) {
	...
	if !IsNil(o.ReasonForNoSessionReplay) {
		toSerialize["reasonForNoSessionReplay"] = o.ReasonForNoSessionReplay
	}
	if !IsNil(o.ReasonForNoSessionReplayMobile) {
		toSerialize["reasonForNoSessionReplayMobile"] = o.ReasonForNoSessionReplayMobile
	}
	if !IsNil(o.Region) {
		toSerialize["region"] = o.Region
	}
	if !IsNil(o.ReplayEnd) {
		toSerialize["replayEnd"] = o.ReplayEnd
	}
	if !IsNil(o.ReplayStart) {
		toSerialize["replayStart"] = o.ReplayStart
	}
	if !IsNil(o.RootedOrJailbroken) {
		toSerialize["rootedOrJailbroken"] = o.RootedOrJailbroken
	}
	if !IsNil(o.ScreenHeight) {
		toSerialize["screenHeight"] = o.ScreenHeight
	}
	if !IsNil(o.ScreenOrientation) {
