...
// checks if the METag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &METag{}
...
func (o METag) ToMap() (map[string]interface{}, error) {
