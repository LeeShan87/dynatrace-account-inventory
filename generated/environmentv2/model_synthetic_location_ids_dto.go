...
// checks if the SyntheticLocationIdsDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyntheticLocationIdsDto{}
...
func (o SyntheticLocationIdsDto) ToMap() (map[string]interface{}, error) {
