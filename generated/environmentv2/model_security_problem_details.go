...
type SecurityProblemDetails struct {
	...
	RelatedContainerImages []SecurityProblemDetailsRelatedContainerImagesInner `json:"relatedContainerImages,omitempty"`
...
func (o *SecurityProblemDetails) GetRelatedContainerImages() []SecurityProblemDetailsRelatedContainerImagesInner {
	if o == nil || IsNil(o.RelatedContainerImages) {
		var ret []SecurityProblemDetailsRelatedContainerImagesInner
		return ret
	}
...
// SetRelatedContainerImages gets a reference to the given []SecurityProblemDetailsRelatedContainerImagesInner and assigns it to the RelatedContainerImages field.
