...
func Test_environmentv2_SyntheticLocationsNodesAndConfigurationAPIService(t *testing.T) {
	...
	t.Run("Test SyntheticLocationsNodesAndConfigurationAPIService GetConfiguration", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SyntheticLocationsNodesAndConfigurationAPI.GetConfiguration(context.Background()).Execute()
	...
	t.Run("Test SyntheticLocationsNodesAndConfigurationAPIService GetLocationDemploymentApplyCommands", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		httpRes, err := apiClient.SyntheticLocationsNodesAndConfigurationAPI.GetLocationDemploymentApplyCommands(context.Background()).Execute()
	...
	t.Run("Test SyntheticLocationsNodesAndConfigurationAPIService GetLocationDemploymentDeleteCommands", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var locationId string

		httpRes, err := apiClient.SyntheticLocationsNodesAndConfigurationAPI.GetLocationDemploymentDeleteCommands(context.Background(), locationId).Execute()
	...
	t.Run("Test SyntheticLocationsNodesAndConfigurationAPIService GetLocationDemploymentYaml", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var locationId string

		httpRes, err := apiClient.SyntheticLocationsNodesAndConfigurationAPI.GetLocationDemploymentYaml(context.Background(), locationId).Execute()
	...
	t.Run("Test SyntheticLocationsNodesAndConfigurationAPIService UpdateConfiguration", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.SyntheticLocationsNodesAndConfigurationAPI.UpdateConfiguration(context.Background()).Execute()
