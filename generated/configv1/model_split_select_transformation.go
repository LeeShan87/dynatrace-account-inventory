...
// checks if the SplitSelectTransformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SplitSelectTransformation{}
...
func NewSplitSelectTransformation(delimiter string, itemIndex int32, type_ string) *SplitSelectTransformation {
...
func (o SplitSelectTransformation) ToMap() (map[string]interface{}, error) {
