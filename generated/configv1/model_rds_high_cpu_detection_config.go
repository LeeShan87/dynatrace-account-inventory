...
// checks if the RdsHighCpuDetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RdsHighCpuDetectionConfig{}
...
func (o RdsHighCpuDetectionConfig) ToMap() (map[string]interface{}, error) {
