...
// checks if the OneAgentHostGroupConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OneAgentHostGroupConfig{}
...
func (o OneAgentHostGroupConfig) ToMap() (map[string]interface{}, error) {
