...
// checks if the StringRequestAttributeComparisonInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StringRequestAttributeComparisonInfo{}
...
func NewStringRequestAttributeComparisonInfo(comparison string, requestAttribute string, negate bool, type_ string) *StringRequestAttributeComparisonInfo {
...
func (o StringRequestAttributeComparisonInfo) ToMap() (map[string]interface{}, error) {
