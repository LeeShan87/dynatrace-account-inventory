...
// checks if the ContextRootTransformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextRootTransformation{}
...
func (o ContextRootTransformation) ToMap() (map[string]interface{}, error) {
