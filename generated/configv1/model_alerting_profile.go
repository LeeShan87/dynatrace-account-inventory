...
// checks if the AlertingProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingProfile{}
...
func (o *AlertingProfile) GetEventTypeFilters() []AlertingEventTypeFilter {
	if o == nil || IsNil(o.EventTypeFilters) {
...
func (o AlertingProfile) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["displayName"] = o.DisplayName
	if !IsNil(o.EventTypeFilters) {
