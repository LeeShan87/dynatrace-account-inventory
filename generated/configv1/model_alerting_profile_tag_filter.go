...
// checks if the AlertingProfileTagFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingProfileTagFilter{}
...
func (o AlertingProfileTagFilter) ToMap() (map[string]interface{}, error) {
