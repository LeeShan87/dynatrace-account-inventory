...
// checks if the UserActionNamingRuleCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserActionNamingRuleCondition{}
...
func (o UserActionNamingRuleCondition) ToMap() (map[string]interface{}, error) {
