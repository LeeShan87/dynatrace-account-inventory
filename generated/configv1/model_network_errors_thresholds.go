...
// checks if the NetworkErrorsThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkErrorsThresholds{}
...
func (o NetworkErrorsThresholds) ToMap() (map[string]interface{}, error) {
