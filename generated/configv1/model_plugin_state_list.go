...
// checks if the PluginStateList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginStateList{}
...
func (o PluginStateList) ToMap() (map[string]interface{}, error) {
