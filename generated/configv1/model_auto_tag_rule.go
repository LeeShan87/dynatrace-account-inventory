...
// checks if the AutoTagRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoTagRule{}
...
func (o *AutoTagRule) SetNormalizationNil() {
...
func (o AutoTagRule) ToMap() (map[string]interface{}, error) {
