...
// checks if the NetworkHighRetransmissionThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkHighRetransmissionThresholds{}
...
func (o NetworkHighRetransmissionThresholds) ToMap() (map[string]interface{}, error) {
