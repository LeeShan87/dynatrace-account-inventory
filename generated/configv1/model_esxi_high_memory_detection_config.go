...
// checks if the EsxiHighMemoryDetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsxiHighMemoryDetectionConfig{}
...
func (o EsxiHighMemoryDetectionConfig) ToMap() (map[string]interface{}, error) {
