...
// checks if the RdsHighLatencyThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RdsHighLatencyThresholds{}
...
func (o RdsHighLatencyThresholds) ToMap() (map[string]interface{}, error) {
