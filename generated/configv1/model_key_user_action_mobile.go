...
// checks if the KeyUserActionMobile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyUserActionMobile{}

// KeyUserActionMobile A key user action.
...
func (o KeyUserActionMobile) ToMap() (map[string]interface{}, error) {
