...
// checks if the RemoveNumbersTransformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveNumbersTransformation{}
...
func NewRemoveNumbersTransformation(minDigitCount int32, type_ string) *RemoveNumbersTransformation {
...
func (o *RemoveNumbersTransformation) GetIncludeHexNumbers() bool {
	if o == nil || IsNil(o.IncludeHexNumbers) {
		var ret bool
		return ret
	}
...
func (o RemoveNumbersTransformation) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.IncludeHexNumbers) {
