...
// checks if the UserActionNamingPlaceholderProcessingStep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserActionNamingPlaceholderProcessingStep{}
...
func (o *UserActionNamingPlaceholderProcessingStep) GetFallbackToInput() bool {
	if o == nil || IsNil(o.FallbackToInput) {
		var ret bool
		return ret
	}
...
func (o *UserActionNamingPlaceholderProcessingStep) GetPatternAfterSearchType() string {
	if o == nil || IsNil(o.PatternAfterSearchType) {
		var ret string
		return ret
	}
...
func (o *UserActionNamingPlaceholderProcessingStep) GetPatternBefore() string {
	if o == nil || IsNil(o.PatternBefore) {
		var ret string
		return ret
	}
...
func (o *UserActionNamingPlaceholderProcessingStep) GetPatternBeforeSearchType() string {
	if o == nil || IsNil(o.PatternBeforeSearchType) {
		var ret string
		return ret
	}
...
func (o *UserActionNamingPlaceholderProcessingStep) GetPatternToReplace() string {
	if o == nil || IsNil(o.PatternToReplace) {
		var ret string
		return ret
	}
