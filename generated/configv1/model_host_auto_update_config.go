...
// checks if the HostAutoUpdateConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostAutoUpdateConfig{}
...
func (o HostAutoUpdateConfig) ToMap() (map[string]interface{}, error) {
