...
// checks if the RdsHighMemoryThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RdsHighMemoryThresholds{}
...
func (o RdsHighMemoryThresholds) ToMap() (map[string]interface{}, error) {
