...
// checks if the DashboardStub type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DashboardStub{}
...
func (o DashboardStub) ToMap() (map[string]interface{}, error) {
