...
// checks if the IpAddressMappingRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpAddressMappingRule{}
...
func (o IpAddressMappingRule) ToMap() (map[string]interface{}, error) {
