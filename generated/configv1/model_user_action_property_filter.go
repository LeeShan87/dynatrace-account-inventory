...
// checks if the UserActionPropertyFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserActionPropertyFilter{}
...
func (o UserActionPropertyFilter) ToMap() (map[string]interface{}, error) {
