...
// checks if the CustomHostMetadataKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomHostMetadataKey{}
...
func (o CustomHostMetadataKey) ToMap() (map[string]interface{}, error) {
