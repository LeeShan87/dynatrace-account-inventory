...
// checks if the UndersizedStorageThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UndersizedStorageThresholds{}
...
func (o UndersizedStorageThresholds) ToMap() (map[string]interface{}, error) {
