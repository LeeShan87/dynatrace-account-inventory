...
// checks if the UserSessionQueryTile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSessionQueryTile{}
...
func NewUserSessionQueryTile(customName string, query string, type_ string, bounds TileBounds, name string, tileType string) *UserSessionQueryTile {
...
func (o *UserSessionQueryTile) GetTimeFrameShift() string {
	if o == nil || IsNil(o.TimeFrameShift) {
		var ret string
		return ret
	}
...
func (o *UserSessionQueryTile) GetVisualizationConfig() UserSessionQueryTileConfiguration {
	if o == nil || IsNil(o.VisualizationConfig) {
...
func (o UserSessionQueryTile) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TimeFrameShift) {
		toSerialize["timeFrameShift"] = o.TimeFrameShift
	}
	toSerialize["type"] = o.Type
	if !IsNil(o.VisualizationConfig) {
