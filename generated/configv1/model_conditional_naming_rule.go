...
// checks if the ConditionalNamingRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionalNamingRule{}
...
func (o ConditionalNamingRule) ToMap() (map[string]interface{}, error) {
