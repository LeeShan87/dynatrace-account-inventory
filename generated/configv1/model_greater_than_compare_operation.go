...
// checks if the GreaterThanCompareOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GreaterThanCompareOperation{}
...
func NewGreaterThanCompareOperation(value int32, type_ string) *GreaterThanCompareOperation {
...
func (o GreaterThanCompareOperation) ToMap() (map[string]interface{}, error) {
