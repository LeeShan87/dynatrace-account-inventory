...
// checks if the AlertingPredefinedEventFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingPredefinedEventFilter{}
...
func (o AlertingPredefinedEventFilter) ToMap() (map[string]interface{}, error) {
