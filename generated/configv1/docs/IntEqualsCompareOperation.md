...
**Values** | **[]int32** | The value to compare to.   If several values are specified, the OR logic applies. | 

## Methods

### NewIntEqualsCompareOperation

`func NewIntEqualsCompareOperation(values []int32, ) *IntEqualsCompareOperation`
