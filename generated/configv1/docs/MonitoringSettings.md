...
**AngularPackageName** | Pointer to **string** | The name of the angular package. | [optional] 
...
**LibraryFileLocation** | Pointer to **string** | The location of your application’s custom JavaScript library file.    If nothing specified the root directory of your web server is used.    **Required** for auto-injected applications, not supported by agentless applications. | [optional] 
**MonitoringDataPath** | Pointer to **string** | The location to send monitoring data from the JavaScript tag.   Specify either a relative or an absolute URL. If you use an absolute URL, data will be sent using CORS.    **Required** for auto-injected applications, optional for agentless applications. | [optional] 
