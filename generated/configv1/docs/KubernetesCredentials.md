...
**ActiveGateGroup** | Pointer to **string** | Active Gate group to filter active gates for this credentials. | [optional] 
...
**DavisEventsIntegrationEnabled** | Pointer to **bool** | Inclusion of all Davis relevant events is enabled (&#x60;true&#x60;) or disabled (&#x60;false&#x60;) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected. | [optional] 
...
**PrometheusExportersIntegrationEnabled** | Pointer to **bool** | Prometheus exporters integration is enabled (&#x60;true&#x60;) or disabled (&#x60;false&#x60;) for the Kubernetes cluster. If the field is omitted during an update, the old value remains unaffected. | [optional] 
