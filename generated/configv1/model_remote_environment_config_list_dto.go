...
// checks if the RemoteEnvironmentConfigListDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteEnvironmentConfigListDto{}
...
func (o RemoteEnvironmentConfigListDto) ToMap() (map[string]interface{}, error) {
