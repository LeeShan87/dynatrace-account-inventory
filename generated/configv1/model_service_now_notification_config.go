...
// checks if the ServiceNowNotificationConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceNowNotificationConfig{}
...
func NewServiceNowNotificationConfig(message string, sendEvents bool, sendIncidents bool, username string, active bool, alertingProfile string, name string, type_ string) *ServiceNowNotificationConfig {
...
func (o ServiceNowNotificationConfig) ToMap() (map[string]interface{}, error) {
