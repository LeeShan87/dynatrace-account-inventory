...
// checks if the WebApplicationConfigBrowserRestriction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebApplicationConfigBrowserRestriction{}
...
func (o WebApplicationConfigBrowserRestriction) ToMap() (map[string]interface{}, error) {
