...
// checks if the ExtensionProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtensionProperty{}
...
func (o ExtensionProperty) ToMap() (map[string]interface{}, error) {
