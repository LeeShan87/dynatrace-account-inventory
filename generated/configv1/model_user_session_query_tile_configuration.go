...
// checks if the UserSessionQueryTileConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSessionQueryTileConfiguration{}
...
func (o *UserSessionQueryTileConfiguration) GetHasAxisBucketing() bool {
	if o == nil || IsNil(o.HasAxisBucketing) {
		var ret bool
		return ret
	}
...
func (o UserSessionQueryTileConfiguration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HasAxisBucketing) {
