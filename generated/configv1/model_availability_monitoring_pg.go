...
// checks if the AvailabilityMonitoringPG type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityMonitoringPG{}
...
func (o AvailabilityMonitoringPG) ToMap() (map[string]interface{}, error) {
