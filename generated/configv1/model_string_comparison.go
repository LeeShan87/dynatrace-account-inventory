...
// checks if the StringComparison type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StringComparison{}
...
func NewStringComparison(operator string, negate bool, type_ string) *StringComparison {
...
func (o StringComparison) ToMap() (map[string]interface{}, error) {
