...
// checks if the StringComparisonInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StringComparisonInfo{}
...
func NewStringComparisonInfo(comparison string, negate bool, type_ string) *StringComparisonInfo {
...
func (o StringComparisonInfo) ToMap() (map[string]interface{}, error) {
