...
// checks if the CustomFilterChartSeriesDimensionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomFilterChartSeriesDimensionConfig{}
...
func (o *CustomFilterChartSeriesDimensionConfig) GetEntityDimension() bool {
	if o == nil || IsNil(o.EntityDimension) {
		var ret bool
		return ret
	}
...
func (o CustomFilterChartSeriesDimensionConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EntityDimension) {
