...
// checks if the DroppedPacketsThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DroppedPacketsThresholds{}
...
func (o DroppedPacketsThresholds) ToMap() (map[string]interface{}, error) {
