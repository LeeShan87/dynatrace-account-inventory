...
// checks if the TechMonitoringList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechMonitoringList{}
...
func (o TechMonitoringList) ToMap() (map[string]interface{}, error) {
