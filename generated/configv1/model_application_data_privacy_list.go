...
// checks if the ApplicationDataPrivacyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationDataPrivacyList{}
...
func (o ApplicationDataPrivacyList) ToMap() (map[string]interface{}, error) {
