...
// checks if the CustomService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomService{}
...
func (o *CustomService) GetQueueEntryPointType() string {
	if o == nil || IsNil(o.QueueEntryPointType) {
		var ret string
		return ret
	}
...
func (o CustomService) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QueueEntryPointType) {
