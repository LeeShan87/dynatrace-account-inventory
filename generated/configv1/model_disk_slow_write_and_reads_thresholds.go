...
// checks if the DiskSlowWriteAndReadsThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskSlowWriteAndReadsThresholds{}
...
func (o DiskSlowWriteAndReadsThresholds) ToMap() (map[string]interface{}, error) {
