...
// checks if the TagFilterAlertingScope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagFilterAlertingScope{}
...
func NewTagFilterAlertingScope(tagFilter TagFilter, filterType string) *TagFilterAlertingScope {
...
func (o TagFilterAlertingScope) ToMap() (map[string]interface{}, error) {
