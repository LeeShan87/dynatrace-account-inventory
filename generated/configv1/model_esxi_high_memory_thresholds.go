...
// checks if the EsxiHighMemoryThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsxiHighMemoryThresholds{}
...
func (o EsxiHighMemoryThresholds) ToMap() (map[string]interface{}, error) {
