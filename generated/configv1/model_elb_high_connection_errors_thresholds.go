...
// checks if the ElbHighConnectionErrorsThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElbHighConnectionErrorsThresholds{}
...
func (o ElbHighConnectionErrorsThresholds) ToMap() (map[string]interface{}, error) {
