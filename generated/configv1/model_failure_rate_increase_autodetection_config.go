...
// checks if the FailureRateIncreaseAutodetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailureRateIncreaseAutodetectionConfig{}
...
func (o FailureRateIncreaseAutodetectionConfig) ToMap() (map[string]interface{}, error) {
