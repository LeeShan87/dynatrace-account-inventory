...
// checks if the AzureComputeModeComparison type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureComputeModeComparison{}
...
func NewAzureComputeModeComparison(operator string, negate bool, type_ string) *AzureComputeModeComparison {
...
func (o AzureComputeModeComparison) ToMap() (map[string]interface{}, error) {
