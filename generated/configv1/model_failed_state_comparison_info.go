...
// checks if the FailedStateComparisonInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailedStateComparisonInfo{}
...
func NewFailedStateComparisonInfo(comparison string, negate bool, type_ string) *FailedStateComparisonInfo {
...
func (o FailedStateComparisonInfo) ToMap() (map[string]interface{}, error) {
