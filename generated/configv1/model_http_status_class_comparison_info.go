...
// checks if the HttpStatusClassComparisonInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpStatusClassComparisonInfo{}
...
func NewHttpStatusClassComparisonInfo(comparison string, negate bool, type_ string) *HttpStatusClassComparisonInfo {
...
func (o HttpStatusClassComparisonInfo) ToMap() (map[string]interface{}, error) {
