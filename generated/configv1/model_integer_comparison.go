...
// checks if the IntegerComparison type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegerComparison{}
...
func NewIntegerComparison(operator string, negate bool, type_ string) *IntegerComparison {
...
func (o IntegerComparison) ToMap() (map[string]interface{}, error) {
