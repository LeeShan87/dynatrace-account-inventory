...
// checks if the UrlPath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UrlPath{}
...
func (o UrlPath) ToMap() (map[string]interface{}, error) {
