...
// checks if the StartsWithCompareOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StartsWithCompareOperation{}
...
func NewStartsWithCompareOperation(values []string, type_ string) *StartsWithCompareOperation {
...
func (o StartsWithCompareOperation) ToMap() (map[string]interface{}, error) {
