...
// checks if the HighCpuSaturationDetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HighCpuSaturationDetectionConfig{}
...
func (o HighCpuSaturationDetectionConfig) ToMap() (map[string]interface{}, error) {
