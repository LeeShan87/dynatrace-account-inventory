...
// checks if the ComparisonBasic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComparisonBasic{}

// ComparisonBasic Defines how the matching is actually performed: what and how are we comparing.   The actual set of fields and possible values of the **operator** field depend on the type of the comparison. Find the list of actual objects in the description of the **type** field or see [JSON models](https://dt-url.net/0b83s6z).
...
func (o ComparisonBasic) ToMap() (map[string]interface{}, error) {
