...
// checks if the VisitDurationDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VisitDurationDetails{}
...
func (o VisitDurationDetails) ToMap() (map[string]interface{}, error) {
