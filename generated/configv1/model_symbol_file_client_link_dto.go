...
// checks if the SymbolFileClientLinkDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SymbolFileClientLinkDto{}
...
func (o SymbolFileClientLinkDto) ToMap() (map[string]interface{}, error) {
