...
// checks if the ConditionsOpaqueAndExternalWebServiceAttributeTypeDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionsOpaqueAndExternalWebServiceAttributeTypeDto{}
...
func (o ConditionsOpaqueAndExternalWebServiceAttributeTypeDto) ToMap() (map[string]interface{}, error) {
