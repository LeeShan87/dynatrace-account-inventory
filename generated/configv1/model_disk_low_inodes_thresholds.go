...
// checks if the DiskLowInodesThresholds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskLowInodesThresholds{}
...
func (o DiskLowInodesThresholds) ToMap() (map[string]interface{}, error) {
