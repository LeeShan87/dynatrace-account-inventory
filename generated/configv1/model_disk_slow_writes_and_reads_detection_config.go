...
// checks if the DiskSlowWritesAndReadsDetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskSlowWritesAndReadsDetectionConfig{}
...
func (o DiskSlowWritesAndReadsDetectionConfig) ToMap() (map[string]interface{}, error) {
