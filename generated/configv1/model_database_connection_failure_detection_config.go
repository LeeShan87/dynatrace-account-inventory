...
// checks if the DatabaseConnectionFailureDetectionConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseConnectionFailureDetectionConfig{}
...
func (o *DatabaseConnectionFailureDetectionConfig) GetConnectionFailsCount() int32 {
	if o == nil || IsNil(o.ConnectionFailsCount) {
		var ret int32
		return ret
	}
...
func (o *DatabaseConnectionFailureDetectionConfig) GetTimePeriodMinutes() int32 {
	if o == nil || IsNil(o.TimePeriodMinutes) {
		var ret int32
		return ret
	}
...
func (o DatabaseConnectionFailureDetectionConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ConnectionFailsCount) {
		toSerialize["connectionFailsCount"] = o.ConnectionFailsCount
	}
	toSerialize["enabled"] = o.Enabled
	if !IsNil(o.TimePeriodMinutes) {
