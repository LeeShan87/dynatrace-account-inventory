...
// checks if the BeaconDomainPattern type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BeaconDomainPattern{}
...
func (o BeaconDomainPattern) ToMap() (map[string]interface{}, error) {
